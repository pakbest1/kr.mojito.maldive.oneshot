...
_pForm._rtnFlatten = [];	//gfnArrayFlatten method에서 사용하는 1차원 배열 저장소.
...
* @memberOf this
*/
_pForm.gfnArrayEach = function(array, func, scope, reverse) 
{
...
* @memberOf this
*/
_pForm.gfnArrayForEach = function(array, func, scope) 
{
	var i, len = array.length;
...
* @memberOf this
*/
_pForm.gfnArrayIndexOf = function(array, item, from, strict) 
{
...
* @memberOf this
*/
_pForm.gfnArrayLastIndexOf = function(array, item, from, strict) 
{
	var i;
...
* @memberOf this
*/
_pForm.gfnArrayContains = function(array, item, strict) 
{
...
* @memberOf this
*/
_pForm.gfnArrayToArray = function(iterant, start, end)
{
...
* @memberOf this
*/
_pForm.gfnArrayMap = function(array, func, scope) 
{
...
* @memberOf this
*/
_pForm.gfnArrayEvery = function(array, func, scope) 
{
	if (!func || !(typeof func === "function"))
	{
		return;
...
* @memberOf this
*/
_pForm.gfnArraySome = function(array, func, scope) 
{
	if (!func || !(typeof func === "function"))
	{
		return;
...
* @memberOf this
*/
_pForm.gfnArrayEquals = function(array1, array2) 
{
...
* @memberOf this
*/
_pForm.gfnArrayClean = function(array) 
{
	var results = [], i = 0,
...
* @memberOf this
*/
_pForm.gfnArrayUnique = function(array) 
{
	var i = 0, uniqueArray = [],
		len = array.length, 
		item,
...
* @memberOf this
*/
_pForm.gfnArrayFilter = function(array, func, scope) 
{
	if (!func || !(typeof func === "function"))
	{
		return;
...
* @memberOf this
*/
_pForm.gfnArrayInsertAt = function(array, index, items) 
{
...
* @memberOf this
*/
_pForm.gfnArrayInsertBefore = function(array, items, items2) 
{
...
* @memberOf this
*/
_pForm.gfnArrayRemoveAt = function(array, index) 
{
...
* @memberOf this
*/
_pForm.gfnArrayRemove = function(array, item) 
{
...
* @memberOf this
*/
_pForm.gfnArrayClone = function(array) 
{
...
* @function reduce
*/
_pForm.gfnArrayReduce = Array.prototype.reduce ? function(arr, fn, initValue)
{
...
* @memberOf this
*/
_pForm.gfnArrayFlatten = function(array)
{
	_rtnFlatten = [];
...
* @memberOf this
*/
_pForm._flatten = function(array)
{
	var i, len, 
		v, pThis = this;
...
* @memberOf this
*/
_pForm.gfnArrayMax = function(array) 
{
...
* @memberOf this
*/
_pForm.gfnArrayMin = function(array) 
{
...
* @memberOf this 
*/
_pForm.gfnArraySum = function(array, start, len) 
{
...
* @memberOf this
*/
_pForm.gfnArrayExchange = function(array, from, to) 
{
...
* @memberOf this
*/
_pForm.gfnArrayMove = function(array, from, to) 
{
	var i, tmp;
...
* @memberOf this
*/
_pForm.gfnArraySortOn = function(array) 
{
	var arr, i,
		args = [];
...
* @memberOf this
*/
_pForm.gfnArraySortTwoDimensional = function(arr, sortOrders) 
{
	return arr.sort(function (a, b) 
	{
...
* @memberOf this
*/
_pForm.gfnArrayIndexOfProp = function(array, prop, item, from, strict) 
{
	var len = array.length,
		from = Number(from) || 0,
		strict = strict || false,
...
* @memberOf this
*/
_pForm.gfnArrayLastIndexOfProp = function(array, prop, item, from, strict)
{
	var i, obj, 
		propValue;
...
* @memberOf this
*/
_pForm.gfnArrayDifference = function(arr, arr1) 
{
...
* @memberOf this
*/
_pForm.gfnArrayArrayCopy = function(src, srcPos, dest, destPos, length)
{
	if ( !length ) return;
